...
{
  public static final DefaultHttpResponse RESPONSE_200_NOBODY = new DefaultHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.OK);
  ...
  public static final DefaultHttpResponse RESPONSE_404_NOT_FOUND = new DefaultHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.NOT_FOUND);
  public static final DefaultHttpResponse RESPONSE_GATEWAY_TIMEOUT = new DefaultHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.GATEWAY_TIMEOUT);
  ...
  public static HttpResponse get200WithContentTypeResponse(String contentType)
  {
    ...
    response200WithContentType.setHeader("Content-Type", contentType);
